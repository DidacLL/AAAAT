...
export const profileVariantChannels = Object.freeze({
  list: "aaaat:profile-variant-list",
  create: "aaaat:profile-variant-create",
  update: "aaaat:profile-variant-update",
  remove: "aaaat:profile-variant-remove",
} as const);
...
export const profileVariantInputSchema = z
  .object({
    ...
    content: profileItemContentSchema,
  })
  .strict();
export type ProfileVariantInput = z.infer<typeof profileVariantInputSchema>;

export const profileVariantRecordSchema = profileVariantInputSchema
  .extend({
    id: z.string().uuid(),
...
export interface ProfileVariantDesktopApi {
  readonly profileVariants: {
    readonly list: () => Promise<ProfileVariantRecord[]>;
    readonly create: (input: ProfileVariantInput) => Promise<ProfileVariantRecord[]>;
    readonly update: (input: ProfileVariantUpdate) => Promise<ProfileVariantRecord[]>;
