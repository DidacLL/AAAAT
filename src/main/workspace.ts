...
import candidatureSourcesBriefMigrationSql from "./migrations/008_candidature_sources_brief.sql?raw";
...
const migrations = Object.freeze([
  ...
  migration(8, "candidature-sources-brief", candidatureSourcesBriefMigrationSql),
]);
