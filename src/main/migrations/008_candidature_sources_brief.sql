...
INSERT INTO candidature_fields(
  ...
  ('00000000-0000-4000-8000-000000000101', 'candidature.organization', 'Organisation', 'Organisation, company or other entity offering the opportunity.', 'text', 'one', '[]', 1, 'seed', 'seed'),
  ('00000000-0000-4000-8000-000000000102', 'candidature.role', 'Role', 'Role, position or opportunity title.', 'text', 'one', '[]', 1, 'seed', 'seed'),
  ('00000000-0000-4000-8000-000000000103', 'candidature.location', 'Location', 'Relevant workplace, base or geographic location.', 'text', 'one', '[]', 1, 'seed', 'seed'),
  ('00000000-0000-4000-8000-000000000104', 'candidature.compensation', 'Compensation', 'Compensation, salary, rate or other remuneration information.', 'text', 'one', '[]', 1, 'seed', 'seed'),
  ('00000000-0000-4000-8000-000000000105', 'candidature.application_date', 'Application date', 'Date the user applied, when known and useful.', 'date', 'one', '[]', 1, 'seed', 'seed'),
  ('00000000-0000-4000-8000-000000000106', 'candidature.notes', 'Notes', 'Free-form user notes about the candidature.', 'long_text', 'one', '[]', 1, 'seed', 'seed');
