# ADR 0020 — Portable local AI setup excludes environment validation

**Status:** Accepted for Issue #185
...
Users can move their local AI connection definitions and general preference without hand-editing JSON or coupling portability to whole-workspace backup. A moved setup is intentionally not immediately AI-ready merely because the source machine had validated capabilities; the user revalidates the operations they intend to use.
