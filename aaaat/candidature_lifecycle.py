...
LIFECYCLE_TASKS: tuple[LifecycleTaskSpec, ...] = (
    ...
    LifecycleTaskSpec("recruiter", "field_inference", "Prepare recruiter conversation", "Return recruiter_material with concise recruiter-call notes, likely questions, positioning, logistics and risks.", "call:recruiter", "normal", ("candidature_evaluation", "role_strategy")),
