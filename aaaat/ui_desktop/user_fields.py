...
FIELD_GROUPS = ["Contact", "Professional profile"]

WRITABLE_USER_VARIABLE_SPECS = [
    UserVariableSpec("Contact", "profile.display_name", "Name"),
    UserVariableSpec("Contact", "profile.email", "Email"),
    UserVariableSpec("Contact", "profile.phone", "Phone"),
    UserVariableSpec("Contact", "profile.location", "Location"),
    UserVariableSpec("Contact", "profile.linkedin_url", "LinkedIn"),
    UserVariableSpec("Contact", "profile.github_url", "GitHub"),
    UserVariableSpec("Contact", "profile.portfolio_url", "Portfolio"),
    UserVariableSpec("Professional profile", "profile.summary.default", "Profile summary", multiline=True),
]
...
def collect_writable_user_changes(
...
def has_editable_user_fields(projection: dict[str, Any]) -> bool:
    return bool(grouped_user_fields(projection))
