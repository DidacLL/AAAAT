...
CANDIDATURE_FIELD_SPECS = (
    ...
    CandidatureFieldSpec("Overview", "next_action", "Next action", editable=True, storage_key="next_action", multiline=True),
    ...
    CandidatureFieldSpec("Recruiter call", "smart_question", "Smart question", editable=True, storage_key="smart_question", multiline=True, value_kind="multiline"),
    CandidatureFieldSpec("Recruiter call", "recruiter_material", "Recruiter/interview material", editable=True, storage_key="recruiter_material", multiline=True, value_kind="multiline"),
