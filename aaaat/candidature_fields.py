...
CANDIDATURE_FIELD_SPECS = (
    ...
    CandidatureFieldSpec("Workflow", "status", "Status", editable=True, storage_key="status"),
    ...
    CandidatureFieldSpec("Workflow", "task_queue", "Task queue", read_only_reason="Derived review queue summary", value_kind="summary"),
