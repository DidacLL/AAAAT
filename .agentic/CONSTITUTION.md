...
These durable invariants may change only through an accepted Class D owner decision.

## Product invariants

- AAAAT is local-first. The user's local workspace is authoritative.
- AAAAT is manual-first. Essential operation never depends on AI.
...
- Every durable mutation uses an AAAAT application service.
