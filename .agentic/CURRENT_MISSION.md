...
- start with the simplest demonstrated user-accessible connection appropriate to each slice; do not assume developer API keys or paid API access are the default authentication experience
